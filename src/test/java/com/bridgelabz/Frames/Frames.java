...
public class Frames {
	...
	public void frame() throws InterruptedException {
		...
		driver.get("file:///C:/Users/Akshay/eclipse-workspace/Facebook_Automation_Selenium/Akshay/page2.html");
	...
	public void frames2() throws InterruptedException {
		...
		Thread.sleep(3000);
		driver.findElement(By.id("lastName")).sendKeys("Palande");
		Thread.sleep(3000);
		driver.findElements(By.name("gender")).get(0).click();
		Thread.sleep(3000);
		driver.findElements(By.name("language")).get(0).click();
		Thread.sleep(3000);
		driver.findElement(By.id("email")).sendKeys("sapirli@gmail.com");
		Thread.sleep(3000);
		driver.switchTo().defaultContent();
