...
public class LocatorsXpath {
	...
	public void page() throws InterruptedException {
		...
		Thread.sleep(2000);
		// And
		driver.findElement(By.xpath("//input[@type='text' and @name='lastname'] ")).sendKeys("Palande");
		Thread.sleep(2000);
		// or xpath
		...
		Thread.sleep(2000);
		// Contains
		driver.findElement(By.xpath("//input[contains(@name,'confirmation')]")).sendKeys("Sapirli@gmail.com");
		Thread.sleep(2000);
		// starts-with
		driver.findElement(By.xpath("//input[starts-with(@autocomplete,'new')]")).sendKeys("Aksh@0123");
		Thread.sleep(2000);
		// Relative xpath
